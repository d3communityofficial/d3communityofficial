...
export default function HeroSection() {
  return (
    <div className="md:col-span-2 md:row-span-2 bg-dark-card rounded-bento p-8 md:p-12 border border-dark-border bento-card relative overflow-hidden group flex flex-col justify-between">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(0, 74, 173, 0.3) 0%, transparent 70%)' }}></div>

      <div className="relative z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-bold mb-6" style={{ backgroundColor: 'rgba(0, 74, 173, 0.1)', borderColor: 'rgba(0, 74, 173, 0.3)', color: 'var(--color-primary-light)' }}>
