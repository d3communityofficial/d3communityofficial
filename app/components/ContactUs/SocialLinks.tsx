  ...
  return (
    <div className="bg-dark-card rounded-bento p-6 sm:p-8 border border-dark-border bento-card">
      ...
      <div className="mt-6 pt-6 border-t border-dark-border">
        <div className="flex items-center gap-3 p-4 rounded-xl bg-dark-card-hover border border-dark-border group hover:border-dark-primary transition-all duration-300">
          <div 
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs text-dark-muted mb-1">Email us at</p>
            <a 
              href="mailto:d3communityofficial@gmail.com"
              className="font-semibold text-sm text-dark-text group-hover:text-dark-primary transition-colors duration-300 truncate block"
            >
          ...
          <button
            onClick={(e) => {
              e.preventDefault();
              navigator.clipboard.writeText('d3communityofficial@gmail.com');
              // You can add a toast notification here
            }}
            className="px-3 py-1.5 rounded-lg bg-dark-card border border-dark-border hover:border-dark-primary text-xs font-medium text-dark-muted hover:text-dark-text transition-all duration-300"
